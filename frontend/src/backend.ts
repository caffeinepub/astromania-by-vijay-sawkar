...
import type { ExternalBlob as _ExternalBlob, GalleryItem as _GalleryItem, Gemstone as _Gemstone, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addGalleryItem(arg0: string, arg1: ExternalBlob, arg2: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async addGemstone(arg0: Gemstone): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addGemstone(to_candid_Gemstone_n9(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteGemstone(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteGemstone(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllGemstones(): Promise<Array<Gemstone>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllGemstones();
    ...
    async updateCart(arg0: string, arg1: Array<CartItem>): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updateGemstone(arg0: Gemstone): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateGemstone(to_candid_Gemstone_n9(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_Gemstone_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Gemstone): Gemstone {
...
function from_candid_vec_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Gemstone>): Array<Gemstone> {
    return value.map((x)=>from_candid_Gemstone_n14(_uploadFile, _downloadFile, x));
}
...
function to_candid_Gemstone_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Gemstone): _Gemstone {
